...
URL="https://management.azure.com/subscriptions/$subid/resourceGroups/$resourcegroup/providers/$resourcetype/$resourcename/providers/microsoft.insights/metrics?api-version=2018-01-01&timespan=$start/$end&interval=$timegrain&aggregation=$aggregation&metricnames=$metricname"
